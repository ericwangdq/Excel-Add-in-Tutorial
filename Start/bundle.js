...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  var createPivotTable = function () {
	                    ...
	                    while (1) {
	                      switch (_context.prev = _context.next) {
	                        case 0:
	                          ...
	                          rangeToAnalyze = currentWorksheet.getRange("A1:E7");
	                          rangeToPlacePivot = currentWorksheet.getRange("A11");
	                          ...
	                          currentWorksheet.pivotTables.add("Farm Sales", rangeToAnalyze, rangeToPlacePivot);
	                          _context.next = 7;
	                          return context.sync();
	    ...
	    return function createPivotTable() {
	      return _ref.apply(this, arguments);
	    };
	  }();

	  var addRowsAndColumns = function () {
	        ...
	        while (1) {
	          switch (_context4.prev = _context4.next) {
	            case 0:
	              _context4.next = 2;
	              return Excel.run(function () {
	                var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(context) {
	                  var currentWorksheet, pivotTable;
	                    ...
	                    while (1) {
	                      switch (_context3.prev = _context3.next) {
	                        case 0:
	                          ...
	                          currentWorksheet = context.workbook.worksheets.getActiveWorksheet();
	                          pivotTable = currentWorksheet.pivotTables.getItem("Farm Sales");
	    ...
	    return function addRowsAndColumns() {
	  ...
	  function createDataTable() {
	    Excel.run(function (context) {
	      var currentWorksheet = context.workbook.worksheets.getActiveWorksheet();
	      var expensesTable = currentWorksheet.tables.add("A1:E1", true /*hasHeaders*/
	      );
	      expensesTable.name = "ExpensesTable";

	      expensesTable.getHeaderRowRange().values = [["Farm", "Type", "Classification", "Crates Sold at Farm", "Crates Sold Wholesale"]];

	      expensesTable.rows.add(null /*add at the end*/, [["A Farms", "Lime", "Organic", "300", "2000"], ["A Farms", "Lemon", "Organic", "250", "1800"], ["A Farms", "Orange", "Organic", "300", "2200"], ["B Farms", "Lime", "Conventional", "80", "1000"], ["B Farms", "Lemon", "Conventional", "75", "1230"], ["B Farms", "Orange", "Conventional", "25", "800"]]);
